...
export function addAllLayers(map, projection, fns) {
    ...
    addLayer({ ...styles.OSD, folder_destination: 'GeoJSON-data/Broendby_omrder_med_srlige_drikkevandsinteresser_osd.geojson', hidden: true, visible: false, group_container: grp_fredede });
    addLayer({ ...styles.BNBO,            folder_destination: 'GeoJSON-data/Broendby_boringsnrt_beskyttelsesomrde_bnbo.geojson',              visible: false,               group_container: grp_fredede });
    addLayer({ ...styles.bilagIVarter, folder_destination: 'GeoJSON-data/Broendby_bilag4arter.geojson', visible: false, group_container: grp_fredede });
    addLayer({ ...styles.beskyttedenaturtyper_p3, folder_destination: 'GeoJSON-data/Broendby_bekyttedenaturtyperparagraf3.geojson', visible: false, group_container: grp_fredede });
    ...
    // ----------------------------------------------------------------
    // Udpegning af undersøgelsesområder
    // ----------------------------------------------------------------
    const grp_udpegninger = createGroup({ title: 'Udpegede undersøgelsesområder', fold: 'close' });
    addLayer({ ...styles.broenby_udpegninger,folder_destination: 'GeoJSON-data/udpegninger.geojson',visible: true, group_container: grp_udpegninger });
    ...
    const { layer: lyr_bygninger_indledende, source: jsonSource_bygninger_indledende } =
        addLayer({ ...styles.indledende_damage_cost, folder_destination: 'GeoJSON-data/Bygninger_Skadesberegninger_Broendby.geojson', visible: false, group_container: grp_skadesomkostninger });

    const { layer: lyr_bygninger_sandsynlig, source: jsonSource_bygninger_sandsynlig } =
        addLayer({ ...styles.sandsynlig_damage_cost, folder_destination: 'GeoJSON-data/Bygninger_Skadesberegninger_Broendby.geojson', visible: false, group_container: grp_skadesomkostninger });
    ...
    addLayer({ ...styles.lokalplaner, folder_destination: 'GeoJSON-data/Broendby_lokalplaner.geojson', visible: false, group_container: grp_lokalplaner });
    ...
    addLayer({ ...styles.geo_strandvold,              folder_destination: 'GeoJSON-data/Strandvold.geojson',                 visible: false,               group_container: grp_geomorfologi });
    ...
    addLayer({ ...styles.municipality_outline, folder_destination: 'GeoJSON-data/Broendby.geojson', hidden: true, group_container: grp_baggrund });
