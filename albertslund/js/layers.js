...
export function addAllLayers(map, projection, fns) {
    ...
    addLayer({ ...styles.OSD, folder_destination: 'GeoJSON-data/Albertslund_omrder_med_srlige_drikkevandsinteresser_osd.geojson', visible: false, group_container: grp_fredede });
    addLayer({ ...styles.BNBO,            folder_destination: 'GeoJSON-data/Albertslund_boringsnrt_beskyttelsesomrde_bnbo.geojson',              visible: false,               group_container: grp_fredede });
    addLayer({ ...styles.bilagIVarter, folder_destination: 'GeoJSON-data/Albertslund_bilag4arter.geojson', visible: false, group_container: grp_fredede });
    addLayer({ ...styles.beskyttedenaturtyper_p3, folder_destination: 'GeoJSON-data/Albertslund_bekyttedenaturtyperparagraf3.geojson', visible: false, group_container: grp_fredede });
    ...
    addLayer({ ...styles.borgerhenvendelse_albertslund,folder_destination: 'GeoJSON-data/borgerhenvendelse.geojson',visible: true, group_container: grp_borgerhenvendelser });
...
const { layer: lyr_bygninger_indledende, source: jsonSource_bygninger_indledende } =
    addLayer({ ...styles.indledende_damage_cost, folder_destination: 'GeoJSON-data/Bygninger_Skadesberegninger_Albertslund.geojson', visible: false, group_container: grp_skadesomkostninger });

const { layer: lyr_bygninger_sandsynlig, source: jsonSource_bygninger_sandsynlig } =
    addLayer({ ...styles.sandsynlig_damage_cost, folder_destination: 'GeoJSON-data/Bygninger_Skadesberegninger_Albertslund.geojson', visible: false, group_container: grp_skadesomkostninger });
    // ----------------------------------------------------------------
    ...
    addLayer( { ...styles.buildings_use,      folder_destination: 'GeoJSON-data/Bygningsanvendelse.geojson',            visible: false, group_container: grp_Bygningsattributter });

    const grp_lokalplaner = createGroup({ title: 'Lokalplaner (vedtaget)', fold: 'close', depth: 1, container: grp_analyserdata });
    addLayer({ ...styles.lokalplaner, folder_destination: 'GeoJSON-data/Albertslund_lokalplaner.geojson', visible: false, group_container: grp_lokalplaner });
    ...
    addLayer({ ...styles.groundwater_geo_1m, folder_destination: 'GeoJSON-data/Terraennaert_grundvand_1m_(GEO).geojson', visible: false, group_container: grp_risikoTGVGEO });
    addLayer({ ...styles.groundwater_geo_2m, folder_destination: 'GeoJSON-data/Terraennaert_grundvand_2m_(GEO).geojson', visible: false, group_container: grp_risikoTGVGEO });
    ...
    addLayer({ ...styles.seawater_intrusion, folder_destination: 'GeoJSON-data/Risiko_for_havvandsindsivning.geojson', visible: false, hidden: true, group_container: grp_Risikohavvandindsivning });
    ...
    addLayer({ ...styles.geo_dødislandskab,            folder_destination: 'GeoJSON-data/Doedislandskab.geojson',            visible: false, hidden: true, group_container: grp_geomorfologi });
    addLayer({ ...styles.geo_mose,                     folder_destination: 'GeoJSON-data/Mose.geojson',                      visible: false,               group_container: grp_geomorfologi });
    addLayer({ ...styles.geo_soe,                      folder_destination: 'GeoJSON-data/Soe.geojson',                       visible: false, hidden: true, group_container: grp_geomorfologi });
    ...
    addLayer({ ...styles.geo_toerlagt_marint_forland,  folder_destination: 'GeoJSON-data/Toerlagt_marint_forland.geojson',   visible: false, hidden: true, group_container: grp_geomorfologi });
    addLayer({ ...styles.geo_isoverskrevet_randmoraene,folder_destination: 'GeoJSON-data/Isoverskrevet_randmoraene.geojson', visible: false, hidden: true, group_container: grp_geomorfologi });
    addLayer({ ...styles.geo_soebund,                  folder_destination: 'GeoJSON-data/Soebund.geojson',                   visible: false,               group_container: grp_geomorfologi });
    ...
    addLayer({ ...styles.vestegnpotentialekort,           folder_destination: 'GeoJSON-data/Potentialekort_Vestegnen_2025_v0_smooth_2-0_25.geojson', visible: false, group_container: grp_potentialekort });
    addLayer({ ...styles.vestegn_pejlinger,               folder_destination: 'GeoJSON-data/Pejlinger_Vestegnen_2025_v0.geojson', visible: false, group_container: grp_potentialekort });
    ...
    addLayer( { ...styles.project_varme,     folder_destination: 'GeoJSON-data/Projektflade_Varme.geojson',     visible: false, hidden: true, group_container: grp_projektplanflader });
    ...
    addLayer( { ...styles.plan_vand,         folder_destination: 'GeoJSON-data/Planflade_vand.geojson',         visible: false, hidden: true, group_container: grp_projektplanflader });
    ...
    addLayer({ ...styles.municipality_outline, folder_destination: 'GeoJSON-data/Albertslund.geojson', hidden: true, group_container: grp_baggrund });
