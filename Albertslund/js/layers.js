...
export function addAllLayers(map, projection, fns) {
    ...
    addCategorizedLayer(map, {
        folder_destination: "GeoJSON data/Terrænnært grundvand 1m (GEO).geojson",
        field: "DN",
        categories: [
    ...
    addCategorizedLayer(map, {
        folder_destination: "GeoJSON data/Terrænnært grundvand 2m (GEO).geojson",
        field: "DN",
        categories: [
            { value: "1", fill_color: "#00ccffad", label: "Vinter" },
            { value: "2", fill_color: "#00bb9f96", label: "Vinter og Sommer" },
    ...
    addSingleColorLayer(map, {
        folder_destination: "GeoJSON data/Søbund.geojson",
