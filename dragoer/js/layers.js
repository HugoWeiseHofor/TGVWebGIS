...
export function addAllLayers(map, projection, fns) {
    ...
    addSingleColorLayer(map, { ...styles.geo_erosionsdal,              folder_destination: 'GeoJSON-data/Erosionsdal.geojson',               visible: false, hidden: true, group_container: grp_geomorfologi }, projection);
    ...
    addSingleColorLayer(map, { ...styles.geo_mose,                     folder_destination: 'GeoJSON-data/Mose.geojson',                      visible: false, hidden: true, group_container: grp_geomorfologi }, projection);
