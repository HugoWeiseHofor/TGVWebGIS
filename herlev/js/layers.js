...
export function addAllLayers(map, projection, fns) {
    ...
    addSingleColorLayer(map, { ...styles.sewage_regnvand,         folder_destination: 'GeoJSON-data/Regnvandskloakeret.geojson',        visible: true,                 group_container: grp_kloakering }, projection);
    ...
    addCategorizedLayer(map, { ...styles.OSD, folder_destination: 'GeoJSON-data/Herlev_omrder_med_srlige_drikkevandsinteresser_osd.geojson', visible: false, group_container: grp_fredede }, projection);
    addSingleColorLayer(map, { ...styles.BNBO,            folder_destination: 'GeoJSON-data/Herlev_boringsnrt_beskyttelsesomrde_bnbo.geojson',              visible: false,               group_container: grp_fredede }, projection);
    addSingleColorLayer(map, { ...styles.bilagIVarter, folder_destination: 'GeoJSON-data/Herlev_bilag4arter.geojson', visible: false, group_container: grp_fredede }, projection);
    addCategorizedLayer(map, { ...styles.beskyttedenaturtyper_p3, folder_destination: 'GeoJSON-data/Herlev_bekyttedenaturtyperparagraf3.geojson', visible: false, group_container: grp_fredede }, projection);
    ...
    const { layer: lyr_bygninger_indledende, source: jsonSource_bygninger_indledende } =
        addThematicLayer(map, { ...styles.indledende_damage_cost, folder_destination: 'GeoJSON-data/Bygninger_Skadesberegninger_Herlev.geojson', visible: false, group_container: grp_skadesomkostninger }, projection);

    const { layer: lyr_bygninger_sandsynlig, source: jsonSource_bygninger_sandsynlig } =
        addThematicLayer(map, { ...styles.sandsynlig_damage_cost, folder_destination: 'GeoJSON-data/Bygninger_Skadesberegninger_Herlev.geojson', visible: false, group_container: grp_skadesomkostninger }, projection);
    ...
    addCategorizedLayer(map, { ...styles.lokalplaner, folder_destination: 'GeoJSON-data/Herlev_lokalplaner.geojson', visible: false, group_container: grp_lokalplaner }, projection);
    ...
    addGraduatedLineLayer(map, { ...styles.flow_paths,  folder_destination: 'GeoJSON-data/Stroemningsveje.geojson', visible: false, group_container: grp_vandoplande }, projection);

    const grp_boringer = createGroup({ title: 'Boringer (GEUS Jupiter Database)', fold: 'close', depth: 1, container: grp_analyserdata });
    addClassedPointLayer(map, { ...styles.borehole_deviation_summer, folder_destination: 'GeoJSON-data/deviations_kote_fix_herlev.geojson', visible: false, group_container: grp_boringer }, projection);
    addClassedPointLayer(map, { ...styles.borehole_deviation_vinter, folder_destination: 'GeoJSON-data/deviations_kote_fix_herlev.geojson', visible: false, group_container: grp_boringer }, projection);
    ...
    addSingleColorLayer(map, { ...styles.municipality_outline, folder_destination: 'GeoJSON-data/Herlev.geojson', hidden: true, group_container: grp_baggrund }, projection);
