...
export function addAllLayers(map, projection, fns) {
    ...
    addSingleColorLayer(map, { ...styles.habitat,         folder_destination: 'GeoJSON-data/Habitat_omraader.geojson',        visible: false,               group_container: grp_fredede }, projection);
    addCategorizedLayer(map, { ...styles.OSD, folder_destination: 'GeoJSON-data/osd.geojson', visible: false, group_container: grp_fredede }, projection);
    addSingleColorLayer(map, { ...styles.BNBO,            folder_destination: 'GeoJSON-data/bnbo.geojson',              visible: false,               group_container: grp_fredede }, projection);
    addSingleColorLayer(map, { ...styles.middelalderbyen, folder_destination: 'GeoJSON-data/middelalderbyen.geojson',     visible: false,               group_container: grp_fredede }, projection);
    ...
    addSingleColorLayer(map, { ...styles.line_piped_streams,  folder_destination: 'GeoJSON-data/Roerlagte_vandloeb.geojson',               visible: false,               group_container: grp_fredede }, projection);
    ...
    const { layer: lyr_bygninger_indledende, source: jsonSource_bygninger_indledende } =
        addThematicLayer(map, { ...styles.indledende_damage_cost, folder_destination: 'GeoJSON-data/Bygninger_Skadesberegninger_Koebenhavn.geojson', visible: false, group_container: grp_skadesomkostninger }, projection);

    const { layer: lyr_bygninger_sandsynlig, source: jsonSource_bygninger_sandsynlig } =
        addThematicLayer(map, { ...styles.sandsynlig_damage_cost, folder_destination: 'GeoJSON-data/Bygninger_Skadesberegninger_Koebenhavn.geojson', visible: false, group_container: grp_skadesomkostninger }, projection);
    ...
    addSingleColorLayer(map, { ...styles.geo_dødislandskab,            folder_destination: 'GeoJSON-data/Doedislandskab.geojson',            visible: false,               group_container: grp_geomorfologi }, projection);
    ...
    addSingleColorLayer(map, { ...styles.geo_toerlagt_marint_forland,  folder_destination: 'GeoJSON-data/Toerlagt_marint_forland.geojson',   visible: false,               group_container: grp_geomorfologi }, projection);
    addSingleColorLayer(map, { ...styles.geo_isoverskrevet_randmoraene,folder_destination: 'GeoJSON-data/Isoverskredet_randmoraene.geojson', visible: false,               group_container: grp_geomorfologi }, projection);
    addSingleColorLayer(map, { ...styles.geo_soebund,                  folder_destination: 'GeoJSON-data/Soebund.geojson',                   visible: false, hidden: true, group_container: grp_geomorfologi }, projection);
    ...
    addClassedPointLayer(map, { ...styles.Kalkboringer_RegionH_mut, folder_destination: 'GeoJSON-data/Kalkboringer_RegionH_mut.geojson', visible: false, group_container: grp_kk_foreloebigegislag }, projection);
    addClassedPointLayer(map, { ...styles.Kalkboringer_Ramboll_mut, folder_destination: 'GeoJSON-data/Kalkboringer_Ramboll_mut.geojson', visible: false, group_container: grp_kk_foreloebigegislag }, projection);
    addClassedPointLayer(map, { ...styles.jupiter_tgv_pejlinger_vinter,folder_destination: 'GeoJSON-data/jupiter_tgv_pejlinger_vinter.geojson', visible: false, group_container: grp_kk_foreloebigegislag }, projection);
    addClassedPointLayer(map, { ...styles.jupiter_tgv_pejlinger_i_sand ,folder_destination: 'GeoJSON-data/jupiter_tgv_pejlinger_i_sand.geojson', visible: false, group_container: grp_kk_foreloebigegislag }, projection);
    addClassedPointLayer(map, { ...styles.jupiter_tgv_pejlinger_i_ler ,folder_destination: 'GeoJSON-data/jupiter_tgv_pejlinger_i_ler.geojson', visible: false, group_container: grp_kk_foreloebigegislag }, projection);
    addClassedPointLayer(map, { ...styles.GEO_tgv_nedsivning_pejlinger_vinter ,folder_destination: 'GeoJSON-data/GEO_tgv_nedsivning_pejlinger_vinter.geojson', visible: false, group_container: grp_kk_foreloebigegislag }, projection);
    addClassedPointLayer(map, { ...styles.GEO_tgv_boringer_vinter ,folder_destination: 'GeoJSON-data/GEO_tgv_boringer_vinter_—_geo_tgv_boringer_vinter.geojson', visible: false, group_container: grp_kk_foreloebigegislag }, projection);
    addThematicLayer    (map, { ...styles.TGV_oplande_fra_HIP10m ,folder_destination: 'GeoJSON-data/TGV_oplande_fra_HIP10m_—_TGV_mut_i_kloakoplande_fra_hip10_m.geojson', visible: false, group_container: grp_kk_foreloebigegislag }, projection);

    const grp_potentialekort = createGroup({ title: 'Potentialekort', fold: 'close', depth: 1, container: grp_analyserdata });
    addSingleColorLayer(map, { ...styles.kbhpotentialekort,           folder_destination: 'GeoJSON-data/potentialelinjer.geojson', visible: false, group_container: grp_potentialekort }, projection);
    addSingleColorLayer(map, { ...styles.kbh_pejlinger,               folder_destination: 'GeoJSON-data/Pejlinger_2024.geojson', visible: false, group_container: grp_potentialekort }, projection);
    addSingleColorLayer(map, { ...styles.kbh_tvivlsomme_pejlinger,    folder_destination: 'GeoJSON-data/Tvivlsomme_pejlinger_2024.geojson', visible: false, group_container: grp_potentialekort }, projection);

    // ----------------------------------------------------------------
    // Projekt- og Planflader
    // ----------------------------------------------------------------
    const grp_projektplanflader = createGroup({ title: 'Projekt- og Planflader', fold: 'close' });
    addSingleColorLayer(map,  { ...styles.project_varme,     folder_destination: 'GeoJSON-data/Projektflade_Varme.geojson',     visible: false,               group_container: grp_projektplanflader }, projection);
    ...
    addSingleColorLayer(map,  { ...styles.plan_vand,         folder_destination: 'GeoJSON-data/Planflade_vand.geojson',         visible: false,               group_container: grp_projektplanflader }, projection);
    ...
    addSingleColorLayer(map, { ...styles.municipality_outline, folder_destination: 'GeoJSON-data/Koebenhavn.geojson', hidden: true, group_container: grp_baggrund }, projection);
