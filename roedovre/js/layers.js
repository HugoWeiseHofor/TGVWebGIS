...
export function addAllLayers(map, projection, fns) {
    ...
    addLayer({ ...styles.OSD, folder_destination: 'GeoJSON-data/Roedovre_omrder_med_srlige_drikkevandsinteresser_osd.geojson', hidden: true, visible: false, group_container: grp_fredede });
    addLayer({ ...styles.BNBO,            folder_destination: 'GeoJSON-data/Roedovre_boringsnrt_beskyttelsesomrde_bnbo.geojson',              visible: false,               group_container: grp_fredede });
    addLayer({ ...styles.bilagIVarter, folder_destination: 'GeoJSON-data/Roedovre_bilag4arter.geojson', visible: false, group_container: grp_fredede });
    addLayer({ ...styles.beskyttedenaturtyper_p3, folder_destination: 'GeoJSON-data/Roedovre_bekyttedenaturtyperparagraf3.geojson', visible: false, group_container: grp_fredede });
    ...
    const { layer: lyr_bygninger_indledende, source: jsonSource_bygninger_indledende } =
        addLayer({ ...styles.indledende_damage_cost, folder_destination: 'GeoJSON-data/Bygninger_Skadesberegninger_Roedovre.geojson', visible: false, group_container: grp_skadesomkostninger });

    const { layer: lyr_bygninger_sandsynlig, source: jsonSource_bygninger_sandsynlig } =
        addLayer({ ...styles.sandsynlig_damage_cost, folder_destination: 'GeoJSON-data/Bygninger_Skadesberegninger_Roedovre.geojson', visible: false, group_container: grp_skadesomkostninger });
    ...
    addLayer({ ...styles.lokalplaner, folder_destination: 'GeoJSON-data/Roedovre_lokalplaner.geojson', visible: false, group_container: grp_lokalplaner });
    ...
    addLayer({ ...styles.municipality_outline, folder_destination: 'GeoJSON-data/Roedovre.geojson', hidden: true, group_container: grp_baggrund });
