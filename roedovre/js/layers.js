...
export function addAllLayers(map, projection, fns) {
    ...
    addCategorizedLayer(map, { ...styles.OSD, folder_destination: 'GeoJSON-data/Roedovre_omrder_med_srlige_drikkevandsinteresser_osd.geojson', hidden: true, visible: false, group_container: grp_fredede }, projection);
    addSingleColorLayer(map, { ...styles.BNBO,            folder_destination: 'GeoJSON-data/Roedovre_boringsnrt_beskyttelsesomrde_bnbo.geojson',              visible: false,               group_container: grp_fredede }, projection);
    addSingleColorLayer(map, { ...styles.bilagIVarter, folder_destination: 'GeoJSON-data/Roedovre_bilag4arter.geojson', visible: false, group_container: grp_fredede }, projection);
    addCategorizedLayer(map, { ...styles.beskyttedenaturtyper_p3, folder_destination: 'GeoJSON-data/Roedovre_bekyttedenaturtyperparagraf3.geojson', visible: false, group_container: grp_fredede }, projection);
    ...
    const { layer: lyr_bygninger_indledende, source: jsonSource_bygninger_indledende } =
        addThematicLayer(map, { ...styles.indledende_damage_cost, folder_destination: 'GeoJSON-data/Bygninger_Skadesberegninger_Roedovre.geojson', visible: false, group_container: grp_skadesomkostninger }, projection);

    const { layer: lyr_bygninger_sandsynlig, source: jsonSource_bygninger_sandsynlig } =
        addThematicLayer(map, { ...styles.sandsynlig_damage_cost, folder_destination: 'GeoJSON-data/Bygninger_Skadesberegninger_Roedovre.geojson', visible: false, group_container: grp_skadesomkostninger }, projection);
    ...
    addCategorizedLayer(map, { ...styles.lokalplaner, folder_destination: 'GeoJSON-data/Roedovre_lokalplaner.geojson', visible: false, group_container: grp_lokalplaner }, projection);
