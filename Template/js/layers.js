...
export function addAllLayers(map, projection, fns) {
    ...
    addSingleColorLayer(map, {
        ...
        fill_alpha: 0.85, title: "Habitat områder", visible: false, z_index: 2,
        group_container: grp_fredede
    }, projection);    
    ...
    addSingleColorLayer(map, {
        ...
        title: "Bygninger med kælder", max_resolution: 3, visible: false, z_index: 2, hidden: true,
    ...
    addSingleColorLayer(map, {
        ...
        title: "Bygninger opført efter 1973", max_resolution: 3, visible: false, z_index: 2, hidden: true,
        group_container: grp_Bygningsattributter
    }, projection);
    ...
    addCategorizedLayer(map, {
        ...
        title: "Bygningsanvendelse", max_resolution: 3, z_index: 6, visible: false, hidden: true,
        group_container: grp_Bygningsattributter
    }, projection);
    ...
    addSingleColorLayer(map, {
        ...
        title: "Tørlagt marint forland", visible: false, z_index: 1,
        group_container: grp_geomorfologi
    }, projection); 
    ...
    addSingleColorLayer(map, {
        ...
        title: "Isoverskrevet randmoræne", visible: false, z_index: 1,
        group_container: grp_geomorfologi
    }, projection); 
    ...
    addSingleColorLayer(map, {
        ...
        title: "Projektflade Varme", visible: false, z_index: 1,
    ...
    addSingleColorLayer(map, {
        ...
        title: "Planflade vand", visible: false, z_index: 1,
        group_container: grp_projektplanflader
    }, projection);    
    ...
    addSingleColorLayer(map, {
        folder_destination: "GeoJSON data/københavn.geojson",
