...
export function addAllLayers(map, projection, fns) {
    ...
    addSingleColorLayer(map, {
        ...
        fill_alpha: 0.85, title: "Regnvands kloakeret", visible: true, z_index: 2,
        group_container: grp_kloakering
    }, projection);
    ...
    const grp_fredede = createGroup({ title: 'Fredede & Natur områder', fold: 'close', depth: 1, container: grp_MaskeIKKEkort });
    addSingleColorLayer(map, {
    ...
    addSingleColorLayer(map, {
        folder_destination: "GeoJSON data/Gammel Kystlinje ().geojson",
        fill_color: "rgba(165,207,235,0.7)", stroke_color: "rgba(0,0,0,1)", stroke_width: 0,
        fill_alpha: 0.85, title: "Habitat områder", visible: false, z_index: 2, hidden: true,
        group_container: grp_fredede
    }, projection);    
    ...
    const grp_Indledendeudpegningomraader = createGroup({ title: 'Indledende udpegning af undersøgelsesområder', fold: 'close' });
    addSingleColorLayer(map, {
        folder_destination: "GeoJSON data/Erhvervskvarteret.geojson",
        fill_color: "#edf6fb00", stroke_color: "rgb(255, 0, 0)", stroke_width: 2,
        fill_alpha: 0.85, title: "Erhvervskvarteret", visible: true, z_index: 1,
        group_container: grp_Indledendeudpegningomraader
    }, projection);

    addSingleColorLayer(map, {
        folder_destination: "GeoJSON data/Eventyrkvarteret.geojson",
        fill_color: "#edf6fb00", stroke_color: "rgb(255, 0, 0)", stroke_width: 2,
        fill_alpha: 0.85, title: "Eventyrkvarteret", visible: true, z_index: 1,
        group_container: grp_Indledendeudpegningomraader
    }, projection);

    addSingleColorLayer(map, {
        folder_destination: "GeoJSON data/Musikkvarteret.geojson",
        fill_color: "#edf6fb00", stroke_color: "rgb(255, 0, 0)", stroke_width: 2,
        fill_alpha: 0.85, title: "Musikkvarteret", visible: true, z_index: 1,
        group_container: grp_Indledendeudpegningomraader
    }, projection);
    ...
    addCategorizedLayer(map, {
        folder_destination: "GeoJSON data/Borgerhenvendelser_1.geojson",
        field: "klasse",
        categories: [
            { value: "1", fill_color: "#33ff00", label: "Type 1" },
            { value: "2", fill_color: "#e5ff00", label: "Type 2" },
            { value: "3", fill_color: "#ff0000", label: "Type 3" },
        ],
        default_fill_color: "#999999", point_radius: 5, stroke_color: "#ffffff", stroke_width: 1,
        title: "Borgerhenvendelser, klik punkt for yderligere info", z_index: 6, visible: true,
        group_container: grp_Borgerhenvendelser,
    ...
    addCategorizedLayer(map, {
        folder_destination: "GeoJSON data/Borgerhenvendelser.geojson",
        field: "Adresse",
        categories: [
            { value: "Elverparken", stroke_color: "#a0dc5c", fill_color: "#a0dc5c00", label: "Elverparken" },
            { value: "Tornerosevej 17-63", stroke_color: "#f1ba23", fill_color: "#e5ff0000", label: "Tornerosevej 17-63" },
            { value: "Tornerosevej 75-111", stroke_color: "#f1ba23", fill_color: "#e5ff0000", label: "Tornerosevej 75-111" },
        ],
        default_fill_color: "#999999", stroke_color: "#ffffff", stroke_width: 3,
        title: "Borgerhenvendelser, klik overflade for yderligere info", z_index: 6, visible: true,
        group_container: grp_Borgerhenvendelser,
        attributeTitleField: "attributter",
            attributes: [
        { field: "adresse", label: "Adresse" },
    ...
    addCategorizedLayer(map, {
        ...
        default_fill_color: "#999999", stroke_color: "#ffffff00", stroke_width: 0, fill_alpha: 0.85,
        title: "Vandoplande", z_index: 1, visible: false,
    ...
    addGraduatedLineLayer(map, {
        ...
        fill_alpha: 0.85, z_index: 1, visible: false, maxResolution: 3,
        group_container: grp_vandoplande
    }, projection);
    ...
    addSingleColorLayer(map, {
        ...
        title: "Dødislandskab", visible: false, z_index: 1,
        group_container: grp_geomorfologi
    }, projection);
    ...
    addSingleColorLayer(map, {
        ...
        title: "Tunneldal", visible: false, z_index: 1,
        group_container: grp_geomorfologi
    }, projection); 
    ...
    addCategorizedLayer(map, {
        ...
        field: "STYLE_REGE",
        categories: [
            { value: "Anlægsprojekt", fill_color: "#34cb00", fill_alpha: 0.85, label: "Anlægsprojekt" },
