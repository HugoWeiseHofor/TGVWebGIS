...
import { initLayerSwitcher, registerLayer, baseLayers, createGroup } from './layer-switcher.js';
import {
    addThematicLayer,
    addSingleColorLayer,
    addCategorizedLayer,
...
const extent = [716362.9499999, 6167175.7900, 720528.63, 6174435.86];
...
fetch("https://api.dataforsyningen.dk/topo_skaermkort_daempet_DAF?service=WMTS&request=GetCapabilities&token=b13445c09727289ea77913374cac72ce")
    ...
    .then(text => {
        ...
        registerLayer(wmtsLayer, 'Topografisk (dæmpet)', 'base');
    });

// ==========================
// Initialize Popup (BEFORE loading layers)
// ==========================
initPopup(map);
