...
export function addAllLayers(map, projection, fns) {
    ...
    addLayer({ ...styles.sewage_spildevand,       folder_destination: 'GeoJSON-data/Spildevandskloakering.geojson',    visible: true,                  group_container: grp_kloakering });
    ...
    addLayer({ ...styles.OSD, folder_destination: 'GeoJSON-data/Vallensbaek_omrder_med_srlige_drikkevandsinteresser_osd.geojson', hidden: true, visible: false, group_container: grp_fredede });
    addLayer({ ...styles.BNBO,            folder_destination: 'GeoJSON-data/Vallensbaek_boringsnrt_beskyttelsesomrde_bnbo.geojson',              visible: false,               group_container: grp_fredede });
    addLayer({ ...styles.bilagIVarter, folder_destination: 'GeoJSON-data/Vallensbaek_bilag4arter.geojson', visible: false, group_container: grp_fredede });
    addLayer({ ...styles.beskyttedenaturtyper_p3, folder_destination: 'GeoJSON-data/Vallensbaek_bekyttedenaturtyperparagraf3.geojson', visible: false, group_container: grp_fredede });
    ...
    const { layer: lyr_bygninger_indledende, source: jsonSource_bygninger_indledende } =
        addLayer( { ...styles.indledende_damage_cost, folder_destination: 'GeoJSON-data/Bygninger_Skadesberegninger_Vallensbaek.geojson', visible: false, group_container: grp_skadesomkostninger });

    const { layer: lyr_bygninger_sandsynlig, source: jsonSource_bygninger_sandsynlig } =
        addLayer( { ...styles.sandsynlig_damage_cost, folder_destination: 'GeoJSON-data/Bygninger_Skadesberegninger_Vallensbaek.geojson', visible: false, group_container: grp_skadesomkostninger });
    ...
    addLayer({ ...styles.lokalplaner, folder_destination: 'GeoJSON-data/Vallensbaek_lokalplaner.geojson', visible: false, group_container: grp_lokalplaner });
    ...
    addLayer({ ...styles.municipality_outline, folder_destination: 'GeoJSON-data/Vallensbaek.geojson', hidden: true, group_container: grp_baggrund });
